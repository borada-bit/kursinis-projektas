...
Šio darbo tikslas yra sukurti automatizuotą kriptovaliutų prekybos robotą. 
Darbe tiriama standartinių autoregreisivių modelių veikimas ir gilaus mokymo modelio veikimas.
Darbe tiriama, kokį modelį galima taikyti: autoregresyvųjį ar gilaus mokymo tiksliausiai nuspėti kriptovaliutos kainas ateityje.
Pagal gautus rezultatus ir tikslumą galima spręsti, koks modelis yra tinkamiausias robotui naudoti.


Tikslui įgyvendinti keliami uždaviniai:
\begin{itemize}
  \item Mokslinės literatūros analizė,
  \item Atlikti autoregresinių, gilaus mokymo modelių analizę,
  \item Skirtingų modelių pritaikymas duomenims,
  \item Sukurti robotą gebanti prekiauti šiais modeliais
...
ir duomenų rinkinius, kad būtų galima palyginti su prognozavimo būdais aptartais šiame darbe.
